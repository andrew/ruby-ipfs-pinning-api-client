...
# Unit tests for OpenapiClient::Failure
...
describe 'Failure' do
  ...
  describe 'test an instance of Failure' do
    it 'should create an instance of Failure' do
      expect(@instance).to be_instance_of(OpenapiClient::Failure)
    end
  end
