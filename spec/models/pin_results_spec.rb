...
# Unit tests for OpenapiClient::PinResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PinResults' do
  before do
  ...
  describe 'test an instance of PinResults' do
    it 'should create an instance of PinResults' do
      expect(@instance).to be_instance_of(OpenapiClient::PinResults)
    end
  end
