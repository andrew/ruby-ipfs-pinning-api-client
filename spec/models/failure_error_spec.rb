...
# Unit tests for OpenapiClient::FailureError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FailureError' do
  before do
  ...
  describe 'test an instance of FailureError' do
    it 'should create an instance of FailureError' do
      expect(@instance).to be_instance_of(OpenapiClient::FailureError)
    end
  end
