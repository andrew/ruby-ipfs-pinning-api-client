...
# Models
require 'openapi_client/models/failure'
require 'openapi_client/models/failure_error'
require 'openapi_client/models/pin'
require 'openapi_client/models/pin_results'
require 'openapi_client/models/pin_status'
require 'openapi_client/models/status'

# APIs
require 'openapi_client/api/pins_api'
